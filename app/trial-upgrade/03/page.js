...
export default function DataExcelUpgrade() {
  return (
    <>
      <Nav />
      <main>
        <section style={{ maxWidth: '680px', margin: '0 auto', padding: '140px 24px 40px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1.2rem', color: 'var(--text-muted)', maxWidth: '540px', margin: '0 auto 32px', lineHeight: 1.5 }}>
            You've seen what Proxi can do with <strong>data processing and spreadsheet automation</strong> in 3 days. Here's how we can expand it — dashboard creation, report automation, and data pipeline management — all tailored to your operations.
          </p>
        ...
        <section style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px 48px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 700, textAlign: 'center', marginBottom: '32px' }}>What opens up for your data operations</h2>
          
          <div style={{ display: 'grid', gap: '24px' }}>
            {[
              { title: "Data Automation", desc: "Complex calculations, multi-sheet reports, and data visualizations — generated faster than manual Excel work.", trial: "Sample reports only", full: "Unlimited data workflows" },
              { title: "Report Automation", desc: "Daily, weekly, and monthly reports generated automatically from your data sources and delivered on schedule.", trial: "Static templates only", full: "Dynamic, scheduled reports" },
              { title: "Dashboard Creation", desc: "Live dashboards that update automatically, with charts, KPIs, and alerts based on your data thresholds.", trial: "Sample dashboards only", full: "Unlimited custom dashboards" },
              { title: "Data Pipeline Management", desc: "Connect multiple data sources, clean and validate data automatically, and maintain data integrity across systems.", trial: "Single-source only", full: "Multi-source pipelines" },
