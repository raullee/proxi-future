      ...
      <main>
        ...
        <section style={{ maxWidth: '680px', margin: '0 auto', padding: '140px 24px 40px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1.2rem', color: 'var(--text-muted)', maxWidth: '540px', margin: '0 auto 32px', lineHeight: 1.5 }}>
            You've seen what Proxi can do in 3 days. Now get the full setup — custom website generation, social media automation, and unlimited workflows.
          </p>
        ...
        <section style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px 48px' }}>
          <div className="card" style={{ 
            ...
            <h2 style={{ fontSize: '1.4rem', fontWeight: 700, marginBottom: '8px', color: 'var(--accent)' }}>
              🎁 Pilot Customer Bonus
            </h2>
            <p style={{ fontSize: '1.1rem', fontWeight: 600, marginBottom: '8px' }}>
              RM2,000 setup fee waived
            </p>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-muted)' }}>
              As one of our early adopters, we're covering the full configuration cost. This offer expires <strong>Friday at midnight</strong>.
            </p>
          </div>
        </section>
        ...
        <section style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px 48px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 700, textAlign: 'center', marginBottom: '32px' }}>
            What changes after your trial
          </h2>
          
          <div style={{ display: 'grid', gap: '24px' }}>
            {[
              {
                title: "Custom Website Generation",
                desc: "Your PA builds websites on-demand. Client presentations, landing pages, portfolios — generated in hours, not weeks.",
                trial: "Demo only",
                full: "Unlimited builds"
              },
              {
              ...
              },
              {
                ...
                desc: "Custom automations, document generation, CRM integration, and business logic that adapts to your needs.",
                trial: "Basic tasks only",
                full: "Unlimited complexity"
              },
              {
                title: "Priority Support",
                desc: "WhatsApp access to your PA 24/7, with escalation to our engineering team when needed.",
        ...
        <section style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px 80px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', marginBottom: '32px' }}>
            Your trial showed you the potential. Full Proxi shows you the results.
          </p>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            >
              Save with Yearly — RM4,990
            </a>
          </div>
          
          <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginTop: '16px' }}>
            ✨ Setup fee waived (RM2,000 value) • 📅 Offer expires Friday
          </p>
        </section>
      </main>
      <Footer />
